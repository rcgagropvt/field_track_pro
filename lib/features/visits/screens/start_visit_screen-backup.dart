...
class _StartVisitScreenState extends State<StartVisitScreen> {
  ...
  Future<bool> _checkConnectivity() async {
    ...
    // v5 returns List<ConnectivityResult>; v4 returns a single value
...
// In _endVisit(), replace the online/offline update block:
      if (isOnline) {
        if (_visitId!.startsWith('offline_')) {
          // Check-in was offline. Insert the complete merged record now.
