$projectRoot = "C:\Users\devas\field_track_pro"

# ── party_action_sheet.dart ──────────────────────────────
@'
...
'@ | Set-Content -Path "$projectRoot\lib\features\parties\screens\party_action_sheet.dart" -Encoding UTF8
...
'@ | Set-Content -Path "$projectRoot\lib\features\parties\screens\parties_screen.dart" -Encoding UTF8

# ── party_profile_screen.dart ──────────────────────────────
@'
import 'package:flutter/material.dart';
...
'@ | Set-Content -Path "$projectRoot\lib\features\parties\screens\party_profile_screen.dart" -Encoding UTF8
